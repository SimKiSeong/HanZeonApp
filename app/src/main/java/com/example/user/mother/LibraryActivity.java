...
public class LibraryActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    double garo = 35.0260129;
    double sero = 126.78509559999998;
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        //  이곳에다가 만들면 될꺼 같습니다.
        currentLatLng = new LatLng(garo,sero);
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(LibraryActivity.this)
                .key("AIzaSyCh2WEKY3O_HZI8Y2n8snkEIfvsCcM9QN0")
                .latlng(garo,sero)//현재 위치
                .radius(10000) //10000 미터 내에서 검색
