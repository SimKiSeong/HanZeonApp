...
public void onActivityCreated(Bundle b) {
    ...
    final Chronometer mChronometer= (Chronometer) getView().findViewById(R.id.chronometer_view);


    Button startBtn=(Button) getView().findViewById(R.id.start_button);
    Button stopBtn=(Button) getView().findViewById(R.id.stop_button);
    Button resetBtn=(Button) getView().findViewById(R.id.reset_button);
